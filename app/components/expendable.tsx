  ...
  <div>
    ...
    <div className="pt-4 relative px-4">
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="text-neutral-600 text-[20px]  lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
      >
      ...
      <ul className="projectsList w-[1100px] mx-auto w-full ">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 h-[100%] flex flex-col md:flex-row justify-between items-center hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer"
          >
